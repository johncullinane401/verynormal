...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_CANTESCAPE]                           = COMPOUND_STRING("What are you running from?\p"),
    ...
    [STRINGID_STARTEDTORAIN]                        = COMPOUND_STRING("The rain feels cool against your face."),
    ...
    [STRINGID_RAINCONTINUES]                        = COMPOUND_STRING("Rain continues to fall, to wash away your sins."), //not in gen 5+
    ...
    [STRINGID_ITISRAINING]                          = COMPOUND_STRING("The rain feels cool against your face."),
    [STRINGID_SANDSTORMISRAGING]                    = COMPOUND_STRING("The sandstorm is raging!"),
    [STRINGID_CANTESCAPE2]                          = COMPOUND_STRING("...what are you running from?\p"),
    ...
    [STRINGID_PKMNLOAFING]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} cannot attack! It's crying..."),
    ...
    [STRINGID_AFTERMATHDMG]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} feels the weight of its grief...!"),
