...
const u8 gText_DadsAdvice[] = _("???'s advice…\nYou can't do that.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_RoseNo[] = _("Nobody is coming to save you.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CantUseUntilNewBadge[] = _("You cannot use this here.{PAUSE_UNTIL_PRESS}");
